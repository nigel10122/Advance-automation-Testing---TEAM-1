...
//		MAGIC CODE GOES HERE 
  ...
  @Test
  @FileParameters("test/company_management/selenium/TC01a_test_cases.csv")
  ...
  @Test
  @FileParameters("test/company_management/selenium/TC01b_test_cases.csv")
  public void TC01b(String errMsg) throws Exception {
	driver.get(sAppURL);
    MainApp_function(driver,FunctionEnum.listCompanies); //select list Companies from homepage
//	Click on View company button without selecting a company
	...
	takeScreenShot(driver, new Throwable().getStackTrace()[0].getMethodName() + " select a company error message");
	driver.findElement(By.xpath(prop.getProperty("listCompany_companyMgtAppLink"))).click(); //go back to homepage	
  }

  @Test
  @FileParameters("test/company_management/selenium/TC01c_test_cases.csv")
