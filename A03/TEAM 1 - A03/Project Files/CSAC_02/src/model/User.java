...
public class User {
	...
	public String validateLastname(String lastname) {
		...
		if (!(c >= 'A' && c <= 'Z')) 
		{
			result ="Last name should start with capital letter and must be not be a number"; 
		}
		else
	...
	public String validateFirstname(String lastname) {
		...
		if (!(c >= 'A' && c <= 'Z')) 
		{
			result ="First name should start with capital letter and must be not be a number"; 
		}
		else
			if(!stringSize(lastname,3,29)) {
	...
	public String validateEmail(String email) {
		...
		if (!email.contains("@"))
			...
			if (!stringSize(email,7,45))
				result="Email address must be between 7(inlusive) and 45(inclusive) characters long";
			else {
	...
	public String validateCoordinator()
	{
		String result = "";
		
		if(getAvailability().equals("Unavailable"))
		{
			result = "Coordinator not available";
		}
