                  ...
                  <form onsubmit="return confirm('Are you sure you want to Update your Profie ?');" action="PassengerUpdateProfile"  method="post">
                     ...
                     <table class="padding-table-columns" style = "margin-left:280px;">
                       <!--  <tr>
                        ...
                        <tr>
                           <td><input class = "form-control"  value="<c:out value='${sessionScope.roomnumber}'/>" name="roomnumber" required></td>
                           <td>
                        ...
                        <tr>
                           <td><input class = "form-control"  value="<c:out value='${sessionScope.decknumber}'/>" name="decknumber" required></td>
                           <td>
