...
<form action="LoginServlet" method="post">
   					<p><%=session.getAttribute("InvalidError") == null ? "" : session.getAttribute("InvalidError") %></p>
<table class="padding-table-columns">                    
<tr>
<td><input class = "form-control row1" type="text" placeholder="Username" name="username" required></td>
...
<tr>
<td><input class="form-control row2" type="password" placeholder="Password" name="password" required></td>
