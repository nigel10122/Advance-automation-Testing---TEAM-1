...
<tr>
<td><input class = "form-control" type="number" placeholder="Roomnumber" name="roomnumber" required></td>
...
<tr>
<td><input class = "form-control" type="number" placeholder="Decknumber" name="decknumber" required></td>
