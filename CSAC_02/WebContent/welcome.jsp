...
<tr> 
<td><input class = "form-control" type="date" name="eventdate" id="currentDate" value = "<c:out value='${sessionScope.currentdate}'/>" ></td>
...
<tr>
<td><input class ="form-control" type ="time" value = "<c:out value='${sessionScope.currenttime}'/>"></td>
...
<td><p class = "errorPane"><%=session.getAttribute("usernameError") == null ? "" : session.getAttribute("usernameError") %></p></td>
</tr>
                       <tr>
    <td>
        &nbsp;
...
<td><p class = "errorPane"><%=session.getAttribute("passwordError") == null ? "" : session.getAttribute("passwordError") %></p></td>
</tr>
                       <tr>
    <td>
        &nbsp;
...
<td><p class = "errorPane"><%=session.getAttribute("lastnameError") == null ? "" : session.getAttribute("lastnameError") %></p></td>
</tr>
                       <tr>
    <td>
        &nbsp;
...
<td><p class = "errorPane"><%=session.getAttribute("firstnameError") == null ? "" : session.getAttribute("firstnameError") %></p></td>
</tr>
                       <tr>
    <td>
        &nbsp;
...
<td><p class = "errorPane"><%=session.getAttribute("emailError") == null ? "" : session.getAttribute("emailError") %></p></td>
</tr>
                       <tr>
    <td>
        &nbsp;
...
<td><p class = "errorPane"><%=session.getAttribute("numberError") == null ? "" : session.getAttribute("numberError") %></p></td>
</tr>
                       <tr>
    <td>
        &nbsp;
...
<td><p class = "errorPane"><%=session.getAttribute("roomnumberError") == null ? "" : session.getAttribute("roomnumberError") %></p></td>
</tr>
                       <tr>
    <td>
        &nbsp;
...
<td><p class = "errorPane"><%=session.getAttribute("decknumberError") == null ? "" : session.getAttribute("decknumberError") %></p></td>
                     <tr>
    <td>
        &nbsp;
