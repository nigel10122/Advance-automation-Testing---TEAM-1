...
public class MyFirstWebDriverTest {
  ...
  public void testE09ErrorMsgValidationAndBooking() throws Exception {
    ...
    new Select(driver.findElement(By.id("location"))).selectByVisibleText("Paris");
    ...
    driver.findElement(By.id("first_name")).sendKeys("vratant kumar");
    driver.findElement(By.id("last_name")).clear();
    driver.findElement(By.id("last_name")).sendKeys("chauhan");
    driver.findElement(By.id("address")).clear();
    driver.findElement(By.id("address")).sendKeys("1225 South Pecan Street");
    driver.findElement(By.id("cc_num")).clear();
    driver.findElement(By.id("cc_num")).sendKeys("0000001001769484");
    ...
    driver.findElement(By.id("cc_cvv")).sendKeys("9484");
    try {
