...
public void setErrorMsg() {
	...
	errorPresent.add(membershipError);
	errorPresent.add(roleError);
//	if(!(errorPresent.isEmpty())) {
...
//	}
	...
	public String getMembershipError() {
		return membershipError;
	}
	public void setMembershipError(String membershipError) {
