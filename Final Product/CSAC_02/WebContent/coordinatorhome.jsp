...
<td><p id = "eventdateError" class = "errorPane"><c:out value="${sessionScope.eventdateError}"/></p></td>
</tr>
...
<td><p id = "eventtimeError" class = "errorPane"><c:out value="${sessionScope.starttimeError}"/></p></td>
</tr>
