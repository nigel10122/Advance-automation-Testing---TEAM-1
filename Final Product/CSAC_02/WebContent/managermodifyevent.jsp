...
<tr>
 ...
 <tr>
    ...
    <option disabled>--Current Event Duration --</option>
    <option><c:out value="${EVENTS.duration}" /></option>
    <option>--Change Duration to -- </option>
    <option>00:30:00</option>
    <option>01:00:00</option>
    <option>02:00:00</option>
    </select>
     </td> 
     <td><p class = "errorPane"><c:out value='${sessionScope.durationErrormsg}'/></p></td>
    </tr>
  ...
  <tr>
    ...
    <tr>
      ...
      <td><p class = "errorPane"><c:out value='${sessionScope.locationErrormsg}'/></p></td>
      </tr>
      <tr>
    <td>
        &nbsp;
...
<tr>
    ...
    <td><p class = "errorPane"><c:out value='${sessionScope.numberofattendeesErrormsg}'/></p></td>
    </tr>
  <tr>
    <td>
        &nbsp;
   ...
   <tr>
    ...
    <td><p class = "errorPane"><c:out value='${sessionScope.capacityErrormsg}'/></p></td>
    </tr>
    <tr>
    <td>
        &nbsp;
    ...
    <td><p class = "errorPane"><c:out value='${sessionScope.estattendeesErrormsg}'/></p></td>
    </tr>
